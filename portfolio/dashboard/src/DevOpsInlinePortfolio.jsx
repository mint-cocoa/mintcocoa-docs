...
const runtimeSummaryCards = [
  ...
  {
    title: 'Storage',
    body: 'NAS/NFS 기반 PVC 경로를 붙여 Kubernetes 워크로드의 데이터를 유지할 수 있도록 구성했습니다.',
  },
];
...
const problemStatements = [
  ...
  'NAS/NFS 기반 스토리지를 Kubernetes 워크로드에 연결해 상태 데이터를 유지할 수 있는가?',
];

const platformLayers = [
  ['Management Plane', 'Odroid', '172.30.1.83', 'kubectl, Helm, GitOps 운영 진입점'],
...
const operationNotes = [
  ...
  {
    title: 'Storage',
    body: 'NAS/NFS 기반 PVC 경로를 통해 워크로드 데이터가 Pod 생명주기와 분리되어 유지되도록 구성했습니다.',
  },
];
    ...
    <Shell>
      <section className="hero">
        <div className="hero-copy">
          ...
          <p className="lead">
            NAS와 남은 PC 위에 구성한 Kubernetes 실행 환경에서 GitHub Actions, GHCR, Argo CD로
          ...
          <div className="hero-document-card">
            ...
            <p>C++ edge proxy, 개인 도메인 route, GitOps 배포 흐름, 모니터링을 실제 운영 API와 연결해 문서화했습니다.</p>
            ...
            <div className="hero-tag-list" aria-label="기술 스택">
              {['Kubernetes', 'Argo CD', 'C++ HTTPS Proxy', 'Prometheus', 'NFS Storage'].map((tag) => (
