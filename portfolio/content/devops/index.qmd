...
![Kubernetes production node status](assets/oci/kubectl-oke-node-status.png)
...
![Argo CD staging root application and child applications](assets/gitops/argocd-staging-root.png)
...
![GitHub promotion PR updating the GitOps image tag](assets/gitops/ops-staging-promotion-pr.png)

![GitHub Actions render validation for GitOps manifests](assets/gitops/ops-render-validation.png)
